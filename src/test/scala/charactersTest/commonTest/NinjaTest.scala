...
class NinjaTest extends munit.FunSuite {
  ...
  test("Ninja equality") {
    val ninja1 = new Ninja("Hattori", 100, 80, 70)
    val ninja2 = new Ninja("Hattori", 100, 80, 70)
    val ninja3 = new Ninja("Kasumi", 90, 75, 65)
  ...
  test("Ninja toString") {
    ...
    val expectedString = "Ninja {name: Hattori, healthPoints: 100, defense: 80, weight: 70}"
